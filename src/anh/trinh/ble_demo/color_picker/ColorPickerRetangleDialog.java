package anh.trinh.ble_demo.color_picker;
...
public class ColorPickerRetangleDialog extends Dialog {
	 ...
	 private static class ColorPickerView extends View {  
	  ...
	  ColorPickerView(Context c, OnColorChangeListener l, int color, int defaultColor) {  
	   super(c);  
	   mListener = l;  
	 ...
	 public ColorPickerRetangleDialog(Context context, OnColorChangeListener listener,  
