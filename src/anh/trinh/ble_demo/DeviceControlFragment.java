	...
	private void initialStaticData(){
      ...
      for(int i = 0; i < 12; i++){
    	DeviceInfo mDevInfo = new DeviceInfo();
      	switch (i) {
			case 0:
				mDevInfo.setDevID(0x00000001);
				mDevInfo.setDevVal((short) 0);
				break;
			case 1:
				mDevInfo.setDevID(0x00000002);
				mDevInfo.setDevVal((short) 0);
				break;
			case 2:
			...
			case 3:
				...
				break;
			case 4:
				mDevInfo.setDevID(0x00000043);
				mDevInfo.setDevVal((short) 0);
				break;
			case 5:
				mDevInfo.setDevID(0x00000044);
				mDevInfo.setDevVal((short) 0);
				break;
			case 6:
				mDevInfo.setDevID(0x00000038);
				mDevInfo.setDevVal((short) 0);
				break;
			case 7:
				mDevInfo.setDevID(0x00000078);
				mDevInfo.setDevVal((short) 0);
				break;
			case 8:
				mDevInfo.setDevID(0x00000079);
				mDevInfo.setDevVal((short) 0);
				break;
			case 9:
				mDevInfo.setDevID(0x00000030);
				mDevInfo.setDevVal((short) 0);
				break;
			case 10:
				mDevInfo.setDevID(0x00000031);
				mDevInfo.setDevVal((short) 0);
				break;
			case 11:
				mDevInfo.setDevID(0x00000032);
				mDevInfo.setDevVal((short) 0);
			default:
				mDevInfo.setDevID(0x00000032);
				mDevInfo.setDevVal((short) 0);
...
//			mZoneId = devID.putInt(mDevList.get(i).getDevID()).get(0);
			...
			Log.i(TAG, "Zone " + Integer.toString(mZoneId));
			devID.clear();
